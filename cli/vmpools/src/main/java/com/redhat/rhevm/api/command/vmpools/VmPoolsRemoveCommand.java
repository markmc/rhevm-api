 ...
 * Removes a VM Pool
 */
@Command(scope = "vmpools", name = "remove", description = "Removes a VM Pool.")
public class VmPoolsRemoveCommand extends AbstractRemoveCommand {

    @Argument(index = 0, name = "name", description = "The name of the VM Pool", required = true, multiValued = false)
    protected String name;

    protected Object doExecute() throws Exception {
        doRemove(client.getCollection("vmpools", VmPools.class).getVmPools(), VmPool.class, name);
        return null;
    }
}
