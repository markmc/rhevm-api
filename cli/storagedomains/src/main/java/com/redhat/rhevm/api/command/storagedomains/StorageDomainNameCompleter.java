...
public class StorageDomainNameCompleter extends AbstractNameCompleter {

    protected List<? extends BaseResource> getCollection() throws Exception {
        return client.getCollection("storagedomains", StorageDomains.class).getStorageDomains();
    }
