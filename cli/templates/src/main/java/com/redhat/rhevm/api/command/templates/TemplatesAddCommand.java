 ...
 * Add a new Template.
 */
@Command(scope = "templates", name = "add", description = "Add a new Virtual Machine Template")
public class TemplatesAddCommand extends AbstractAddCommand<Template> {

    @Argument(index = 0, name = "name", description = "Name of the template to add", required = true, multiValued = false)
    protected String name;

    @Option(name = "-v", aliases = { "--vm" }, description = "VM name", required = true, multiValued = false)
    private String vm;
    ...
    protected Object doExecute() throws Exception {
        display(doAdd(getModel(), Template.class, "templates", "template"));
        return null;
    }
