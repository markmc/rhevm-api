...
package com.redhat.rhevm.api.mock.webapp;
 ...
 */
public class MockWebappTest extends Assert {

    private static final String BASE_URL = "http://somehost";
    private static final String RHEVM_CONTEXT_PATH = "/rhevm-api-mock";
    ...
    public void testVmAction() throws Exception {
        doTestPost(VMS_PATH + "/1/start", "<action><async>true</async></action>", 202, null);
    }
