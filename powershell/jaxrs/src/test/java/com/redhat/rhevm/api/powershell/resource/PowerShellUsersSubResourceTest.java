...
public class PowerShellUsersSubResourceTest extends AbstractPowerShellUsersResourceTest<PowerShellUsersSubResource> {
    ...
    protected PowerShellUsersSubResource getResource(Executor executor, PowerShellPoolMap poolMap, PowerShellParser parser) {
        return new PowerShellUsersSubResource(PARENT_ID, executor, poolMap, parser);
    }
