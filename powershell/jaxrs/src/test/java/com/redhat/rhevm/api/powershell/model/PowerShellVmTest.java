...
public class PowerShellVmTest extends PowerShellModelTest {
    ...
    private void testVM(PowerShellVM v, String id, String name, String description, VmType type, VmStatus status, Long memory, int sockets, int cores, String os, boolean stateless, String timezone, Boolean highlyAvailable, Integer highAvailabilityPriority, String cdIsoPath, String hostId, String clusterId, String templateId, String creationTime, String origin) {
    ...
    public void testParse() throws Exception {
        ...
        testVM(vms.get(0), "142bf5b1-04fb-4221-9360-0f9b7dab3013", "foo-1", null, VmType.DESKTOP, VmStatus.UP, 536870912L, 1, 1, "OtherLinux", false, null, true, 100, "foo.iso", "5f38363b-7457-4884-831e-78c27cebb31d", "99408929-82cf-4dc7-a532-9d998063fa95", "3ee77811-f1eb-4d3f-991e-e539dbb2f1f9", "2010-07-20T17:28:18.000Z", "rhev");
        testBootDevices(vms.get(0), BootDevice.HD);
        testDisplay(vms.get(0), DisplayType.SPICE, 5910, "192.168.1.109");

        testVM(vms.get(1), "f9e37917-8382-486f-875d-4045be045d85", "foo-2", null, VmType.DESKTOP, VmStatus.DOWN, 536870912L, 1, 1, "OtherLinux", true, null, false, 0, null, null, "99408929-82cf-4dc7-a532-9d998063fa95", "3ee77811-f1eb-4d3f-991e-e539dbb2f1f9", "2010-07-20T17:33:03.000Z", "vmware");
        testBootDevices(vms.get(1), BootDevice.HD);
        testDisplay(vms.get(1), DisplayType.SPICE, null, null);

        testVM(vms.get(2), "aa0e6522-5baf-4f92-86d3-716883de4359", "test", null, VmType.SERVER, VmStatus.DOWN, 536870912L, 1, 1, "WindowsXP", false, "Europe/London", false, 1, null, null, "99408929-82cf-4dc7-a532-9d998063fa95", "00000000-0000-0000-0000-000000000000", "2010-07-20T10:27:02.000Z", "xen");
        testBootDevices(vms.get(2), BootDevice.HD);
        testDisplay(vms.get(2), DisplayType.VNC, 5910, null);

        testVM(vms.get(3), "5114bb3e-a4e6-44b2-b783-b3eea7d84720", "testf13", null, VmType.DESKTOP, VmStatus.POWERING_DOWN, 536870912L, 1, 1, "OtherLinux", false, null, false, 1, null, null, "99408929-82cf-4dc7-a532-9d998063fa95", "00000000-0000-0000-0000-000000000000", "2010-07-20T10:58:41.000Z", "rhev");
