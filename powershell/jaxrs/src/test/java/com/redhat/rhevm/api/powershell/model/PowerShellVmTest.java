...
public class PowerShellVmTest extends PowerShellModelTest {
    ...
    private void testVM(PowerShellVM v, String id, String name, String description, VmType type, VmStatus status, Long memory, int sockets, int cores, String os, Boolean stateless, boolean highlyAvailable, int highAvailabilityPriority, String cdIsoPath, String floppyPath, String hostId, String clusterId, String templateId, String creationTime, VmOrigin origin) {
        ...
        assertEquals(floppyPath, v.getFloppyPath());
