...
public class PowerShellHostNicTest extends PowerShellModelTest {
    ...
    public void testParseHostNics() throws Exception {
        ...
        testHostNic(nics.get(1), "69f21fcc-87a0-4f3b-8e7c-9919a5844283", "dummy0", HOST_ID, null, "2E:C2:E3:BF:9E:27", null, null, null, null);
        testHostNic(nics.get(2), "c7d29e94-036b-4c99-ad2d-344497ed5d37", "dummy1", HOST_ID, null, "2E:C2:E3:BF:9E:27", null, null, null, null);
        testHostNic(nics.get(3), "041f8795-b157-400d-ae20-d544f8d8c1d0", "bond0", HOST_ID, "test", null, null, null, null, null);
    }
}
