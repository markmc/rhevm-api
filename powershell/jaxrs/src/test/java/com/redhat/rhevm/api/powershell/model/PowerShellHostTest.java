...
public class PowerShellHostTest extends PowerShellModelTest {
    ...
    private void testHost(Host h, String id, String name, HostState state, String clusterId, Boolean storageManager, int port) {
    ...
    public void testParse() throws Exception {
        ...
        testHost(hosts.get(0), "1", "zig", HostState.ACTIVE, "0", true, 54321);
