...
public class PowerShellDomainGroupResource implements DomainGroupResource {

    private PowerShellDomainGroupsResource parent;
    private String id;

    public PowerShellDomainGroupResource(PowerShellDomainGroupsResource parent, String id) {
        this.parent = parent;
        this.id = id;
    }
